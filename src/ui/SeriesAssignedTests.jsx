    ...
    <>
      ...
      <nav aria-label="breadcrumb" className="flex-none">
        <ol className="breadcrumb">
          ...
          <li className="breadcrumb-item active" aria-current="page">Assigned Tests</li>
        </ol>
      </nav>
          ...
          data.tests.map((test, i) =>
            <div key={i} className="bg-white rounded-[10px] p-[10px] shadow flex flex-col gap-[10px] cursor-pointer transition-all duration-300 ease-out hover:scale-[1.05] hover:shadow-lg">
              ...
              <div className="flex items-center gap-[10px] justify-center">
                <div className="border-2 border-dashed border-gray-300 rounded-[5px] bg-gray-100 px-[10px] h-[38px] flex items-center gap-[10px]">
                  <span className="font-bold">Test Code : 21846</span>
                  <i className="fa fa-copy ml-auto"></i>
                </div>
                <a href="#" className="btn btn-outline-primary self-center">Start Test</a>
              </div>
            </div>
          )}
      </div>
...
export default SeriesAssignedTests